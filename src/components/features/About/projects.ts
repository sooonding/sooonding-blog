        ...
        achievements: [
          {
            ...
            items: [
              "카카오 외부 API를 통한 알림톡, 친구톡, SMS/LMS/MMS 등 다양한 메시지 유형을 지원하는 발송 시스템 기획",
              "예약 발송, 대량 발송, 사용자 조건별 시나리오 적용 가능하도록 운영 플로우 정의",
            ],
          },
          {
            title: "기술 검토 및 초기 인프라 제안",
            items: [
              "외부 연동 가능한 메시징 API 서비스사 탐색 및 기술 비교",
          ...
          },
          {
            ...
            items: [
              "개발팀 내 프론트엔드 이탈로 인해,메시지 전송 API 연동 및 에러 대응",
          ...
          },
          {
            title: "비즈니스 성과 기여",
            items: [
              "알림톡 도입 이후 마케팅 메시지 도달률 및 반응률 상승으로 고객사 문의 증가",
        ...
        achievements: [
          {
            ...
            items: [
              ...
              "사용자 관점에서 제품 이해도를 높일 수 있도록 시각 구조 설계",
              "사용자 유형별 니즈를 정리하고, 이를 바탕으로 UX 흐름과 콘텐츠 구성안 작성",
              "퍼소나 분석 및 브랜드 가치 전달 전략을 포함한 킥오프 발표",
            ],
          },
          {
            title: "부서 간 협업 주도 및 일정 조율",
            items: [
              "ClickUp을 통한 프로젝트 관리 및 협업 체계 구축",
              "디자인, 개발 등 유관 부서와의 협업을 조율하며 전체 일정 관리",
              "피드백 반복과 QA를 거치며 실제 구현물의 완성도 확보",
            ],
          },
          {
            title: "런칭 후 제품 반응 개선 기여",
            items: [
              "소개 페이지 오픈 이후 신규 제품군에 대한 문의 증가",
              "콘텐츠 중심 접근 방식이 브랜드 메시지 전달에 효과적으로 작용",
            ],
          },
        ],
      },
